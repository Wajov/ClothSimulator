...
-- } else if (keyword == "ea") {
--     linestream >> mesh.edgeIndices.back()->theta_ideal;
-- } else if (keyword == "el") {
--     linestream >> mesh.edgeIndices.back()->label;
-- } else if (keyword == "f") {
--     vector<Vert*> verts;
--     vector<Node*> nodes;
--     string w;
...
--     vector<Face*> faceIndices = triangulate(verts);
--     for (int f = 0; f < faceIndices.size(); f++)
--         mesh.add(faceIndices[f]);
-- } else if (keyword == "fl") {
--     linestream >> mesh.faceIndices.back()->label;
-- }
